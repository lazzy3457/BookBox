...
Le serveur envoie les push via l'Expo Push Service. Le payload contient `targetUrl`, `notificationId` et `type`. Quand l'utilisateur touche une notification contenant une URL de livre, l'app s'ouvre sur la fiche livre correspondante.
