...
export function AuthForm({ mode }: AuthFormProps) {
  ...
  return (
    <form onSubmit={submit} className="mx-auto mt-20 max-w-md overflow-hidden rounded border border-line bg-panel shadow-poster">
      ...
      <input name="password" type="password" className="mt-3 h-11 w-full rounded border border-line bg-ink px-3 outline-none focus:border-mint" placeholder="Mot de passe" />
