...
-- CreateEnum
CREATE TYPE "ReadingStatus" AS ENUM ('TO_READ', 'READING', 'READ', 'ABANDONED');

-- CreateEnum
CREATE TYPE "ReactionKind" AS ENUM ('LIKE', 'TO_READ');
...
-- CreateIndex
CREATE UNIQUE INDEX "Book_googleBooksVolumeId_key" ON "Book"("googleBooksVolumeId");
...
-- CreateIndex
CREATE UNIQUE INDEX "ReviewReaction_reviewId_userId_kind_key" ON "ReviewReaction"("reviewId", "userId", "kind");
